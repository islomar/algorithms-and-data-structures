...
public abstract class Try <E>
{
    ...
    public static <E> Try<E> of(NoArgumentExpressionWithException<E> noArgumentExpressionWithException)
    {
       try 
       {
           return new Success<>(noArgumentExpressionWithException.evaluate());
       } 
       catch (Exception ex) 
       {
    ...
    public static class Failure<E> extends Try<E>
    {
